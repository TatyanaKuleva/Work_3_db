        ...
        with conn.cursor() as cur:
            for vacancy in data_vacancies:
                cur.execute(
                    ...
                    RETURNING index
                    """, (vacancy['id'], vacancy['name'], vacancy['salary_from'], vacancy['salary_to'],
                          vacancy['salary_currency'], vacancy['url_vacancy'], vacancy['employer_id'],
                          vacancy['employer_name'], vacancy['requirement'], vacancy['responsibility'])
                )
